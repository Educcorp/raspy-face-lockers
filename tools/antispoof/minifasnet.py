# -*- coding: utf-8 -*-
# Vendorizado sin cambios desde:
#   https://github.com/minivision-ai/Silent-Face-Anti-Spoofing
#   src/model_lib/MiniFASNet.py (licencia Apache-2.0, ver
#   tools/antispoof/LICENSE-Silent-Face-Anti-Spoofing).
# Se necesita aquí solo para reconstruir la arquitectura al cargar los
# pesos .pth originales y exportarlos a ONNX (tools/antispoof/convert_to_onnx.py).
# No se usa en producción — el runtime (core/face_recognition.py) corre
# los .onnx resultantes vía onnxruntime, sin depender de PyTorch.
#
# Encabezado original:
# @Time : 20-6-3 下午4:45
# @Author : zhuying
